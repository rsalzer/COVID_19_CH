...
!function(t, e) {
            ...
            drawPoint: function(t, e, n, i, a, r) {
                ...
                if (!(isNaN(n) || n <= 0)) {
                    ...
                    case "triangle":
                        ...
                        break;
                    case "rectRounded":
                        u = n - (d = .516 * n), s = Math.cos(h + F) * u, l = Math.sin(h + F) * u, t.arc(i - s, a - l, d, h - P, h - A), t.arc(i + l, a - s, d, h - A, h), t.arc(i + s, a + l, d, h, h + A), t.arc(i - l, a + s, d, h + A, h + P), t.closePath();
                        break;
                    case "rect":
                        if (!r) {
    ...
    var z = {
            ...
            _parseFont: function(t) {
                var e = W.global,
                    ...
                    i = {
                        ...
                        lineHeight: S.options.toLineHeight(Y(t.lineHeight, e.defaultLineHeight), n),
                        size: n,
            ...
            resolve: function(t, e, n, i) {
                ...
                for (a = 0, r = t.length; a < r; ++a)
                    if (void 0 !== (o = t[a]) && (void 0 !== e && "function" == typeof o && (o = o(e), s = !1), void 0 !== n && S.isArray(o) && (o = o[n], s = !1), void 0 !== o))
            ...
            calculateBarValuePixels: function(t, e, n) {
                ...
                if (v || void 0 === v && void 0 !== b)
                    for (i = 0; i < _ && (a = g[i]).index !== t; ++i)
                        a.stack === b && (r = void 0 === (u = h._parseValue(f[a.index].data[e])).start ? u.end : u.min >= 0 && u.max >= 0 ? u.max : u.min, (m.min < 0 && r < 0 || m.max >= 0 && r > 0) && (y += r));
    ...
    W._set("pie", H.clone(W.doughnut)), W._set("pie", {
        cutoutPercentage: 0
    });
    var $t = Yt,
        Xt = H.valueOrDefault;
    ...
    function Te(t, e, n) {
        ...
        !function(t, e) {
            ...
            H.each(_e, (function(e) {
                Se(t, e, i)
            })), n.reflow = !!t.offsetParent, t.classList.add(ye)
        }(t, (function() {
            if (s.resizer) {
                var e = t.parentNode;
    ...
    function Oe(t) {
        ...
        delete e.resizer, function(t) {
            ...
            n && (H.each(_e, (function(e) {
                De(t, e, n)
            })), delete e.renderProxy), t.classList.remove(ye)
    ...
    var Le = {
            ...
            notify: function(t, e, n) {
                var i,
                    ...
                    u = l.length;
                for (i = 0; i < u; ++i)
                    if ("function" == typeof (s = (r = (a = l[i]).plugin)[e]) && ((o = [t].concat(n || [])).push(a.options), !1 === s.apply(r, o)))
                        return !1;
                return !0
            },
            descriptors: function(t) {
                ...
                return this._plugins.concat(a.plugins || []).forEach((function(t) {
                    if (-1 === n.indexOf(t)) {
                        var e = t.id,
                            a = r[e];
                        !1 !== a && (!0 === a && (a = H.clone(W.global.plugins[e])), n.push(t), i.push({
                            plugin: t,
                            options: a || {}
                        }))
                    }
        ...
        Re = {
            ...
            getScaleDefaults: function(t) {
                return this.defaults.hasOwnProperty(t) ? H.merge({}, [W.scale, this.defaults[t]]) : {}
            },
    ...
    var je = $.extend({
            ...
            update: function(t) {
                ...
                if (m.length) {
                    ...
                    for (e = 0, n = m.length; e < n; ++e)
                        k.push((i = m[e], a = void 0, r = void 0, o = void 0, s = void 0, l = void 0, u = void 0, d = void 0, a = i._xScale, r = i._yScale || i._scale, o = i._index, s = i._datasetIndex, l = i._chart.getDatasetMeta(s).controller, u = l._getIndexScale(), d = l._getValueScale(), {
            ...
            getCaretPosition: function(t, e, n) {
                var i,
                    ...
                    p = e.height;
                if ("center" === c)
                    s = g + p / 2, "left" === h ? (a = (i = f) - u, r = i, o = s + u, l = s - u) : (a = (i = f + m) + u, r = i, o = s - u, l = s + u);
                else if ("left" === h ? (i = (a = f + d + u) - u, r = a + u) : "right" === h ? (i = (a = f + m - d - u) - u, r = a + u) : (i = (a = n.caretX) - u, r = a + u), "top" === c)
                    s = (o = g) - u, l = o;
                else {
                    s = (o = g + p) + u, l = o;
                    var v = r;
            ...
            merger: function(t, e, n, i) {
                if ("xAxes" === t || "yAxes" === t) {
                    ...
                    for (e[t] || (e[t] = []), a = 0; a < s; ++a)
                        o = n[t][a], r = qe(o.type, "xAxes" === t ? "category" : "linear"), a >= e[t].length && e[t].push({}), !e[t][a].type || o.type && o.type !== e[t][a].type ? H.merge(e[t][a], [Re.getScaleDefaults(r), o]) : H.merge(e[t][a], o)
                } else
                    H._merger(t, e, n, i)
            }
        })
    ...
    function Xe(t) {
        ...
        H.each(t.scales, (function(e) {
            me.removeBox(t, e)
        })), e = $e(W.global, W[t.config.type], e), t.options = t.config.options = e, t.ensureScalesHaveIDs(), t.buildOrUpdateScales(), t.tooltip._options = e.tooltips, t.tooltip.initialize()
    }
    function Ke(t, e, n) {
        var i,
            a = function(t) {
    ...
    H.extend(tn.prototype, {
        construct: function(t, e) {
            ...
            e = function(t) {
                ...
                return e.datasets = e.datasets || [], e.labels = e.labels || [], t.options = $e(W.global, W[t.type], t.options || {}), t
            }(e);
        ...
        buildOrUpdateControllers: function() {
            ...
            for (t = 0, e = a.length; t < e; t++) {
                ...
                if (o.type && o.type !== s && (n.destroyDatasetMeta(t), o = n.getDatasetMeta(t)), o.type = s, o.order = r.order || 0, o.index = t, o.controller)
        ...
        update: function(t) {
            ...
            if (t && "object" == typeof t || (t = {
                duration: t,
                lazy: arguments[1]
            }), Xe(i), Le._invalidate(i), !1 !== Le.notify(i, "beforeUpdate")) {
        ...
        updateLayout: function() {
            var t = this;
            !1 !== Le.notify(t, "beforeLayout") && (me.update(this, this.width, this.height), t._layers = [], H.each(t.boxes, (function(e) {
        ...
        bindEvents: function() {
            ...
            H.each(t.options.events, (function(i) {
                ...
                t.resize()
            }, Ie.addEventListener(t, "resize", n), e.resize = n)
        },
    ...
    function hn(t, e, n) {
        var i,
            ...
            s = t._startPixel,
            l = t._endPixel;
        if (!(n && (i = 1 === a ? Math.max(o - s, l - o) : 0 === e ? (t.getPixelForTick(1) - o) / 2 : (o - t.getPixelForTick(r - 1)) / 2, (o += r < e ? i : -i) < s - 1e-6 || o > l + 1e-6)))
            return o
    }
    function cn(t, e, n, i) {
        var a,
        ...
        for (a = 0; a < v; ++a) {
            if (s = n[a].label, l = n[a].major ? e.major : e.minor, t.font = u = l.string, d = i[u] = i[u] || {
                ...
                c = H.measureText(t, d.data, d.gc, c, s), f = h;
        ...
        }(i, v), m = b.indexOf(Math.max.apply(null, b)), p = y.indexOf(Math.max.apply(null, y)), {
            first: _(0),
            last: _(v - 1),
            widest: _(m),
            highest: _(p)
    ...
    function mn(t, e) {
        return H.extend(H.options._parseFont({
            ...
            color: H.options.resolve([e.fontColor, t.fontColor, W.global.defaultFontColor])
        })
    }
    function pn(t) {
        var e = mn(t, t.minor);
        return {
            minor: e,
            major: t.major.enabled ? mn(t, t.major) : e
        }
    }
    function vn(t) {
        var e,
    ...
    var yn = $.extend({
        ...
        _computeGridLineItems: function(t) {
            ...
            for ("top" === w ? (e = F(b.bottom), s = b.bottom - C, u = e - O, h = F(t.top) + O, f = t.bottom) : "bottom" === w ? (e = F(b.top), h = t.top, f = F(t.bottom) - O, s = e + O, u = b.top + C) : "left" === w ? (e = F(b.right), o = b.right - C, l = e - O, d = F(t.left) + O, c = t.right) : (e = F(b.left), d = t.left, c = F(t.right) - O, o = e + O, l = b.left + C), n = 0; n < D; ++n)
                i = S[n] || {}, ln(i.label) && n < S.length || (n === b.zeroLineIndex && x.offset === k ? (g = _.zeroLineWidth, m = _.zeroLineColor, p = _.zeroLineBorderDash || [], v = _.zeroLineBorderDashOffset || 0) : (g = dn(_.lineWidth, n, 1), m = dn(_.color, n, "rgba(0,0,0,0.1)"), p = _.borderDash || [], v = _.borderDashOffset || 0), void 0 !== (a = hn(b, i._index || n, k)) && (r = A(y, a, g), M ? o = l = d = c = r : s = u = h = f = r, P.push({
                    tx1: o,
                    ty1: s,
                    tx2: l,
                    ty2: u,
        ...
        _computeLabelItems: function() {
            var t,
                ...
                k = [];
            for ("top" === m ? (r = c.bottom - _ - x, o = w ? "left" : "center") : "bottom" === m ? (r = c.top + _ + x, o = w ? "right" : "center") : "left" === m ? (a = c.right - (p ? 0 : _) - x, o = p ? "left" : "right") : (a = c.left + (p ? 0 : _) + x, o = p ? "right" : "left"), t = 0, e = b.length; t < e; ++t)
                i = (n = b[t]).label, ln(i) || (s = c.getPixelForTick(n._index || t) + g.labelOffset, u = (l = n.major ? y.major : y.minor).lineHeight, d = sn(i) ? i.length : 1, v ? (a = s, h = "top" === m ? ((w ? 1 : .5) - d) * u : (w ? 0 : .5) * u) : (r = s, h = (1 - d) * u / 2), k.push({
                    x: a,
                    y: r,
                    rotation: w,
                    label: i,
    ...
    function Hn(t) {
        var e = t.ticks;
        return e.display && t.display ? Yn(e.fontSize, W.global.defaultFontSize) + 2 * e.backdropPaddingY : 0
    }
    ...
    function ui(t, e, n, i) {
        ...
        for (a = ni.indexOf(t); a < s - 1; ++a)
            if (o = (r = ei[ni[a]]).steps ? r.steps : ti, r.common && Math.ceil((n - e) / (o * r.size)) <= i)
                return ni[a];
        return ni[s - 1]
    }
    function di(t, e, n) {
    ...
    var hi = xn.extend({
                ...
                for (t = 0, n = (l.data.datasets || []).length; t < n; ++t)
                    if (l.isDatasetVisible(t))
                        if (a = l.data.datasets[t].data, H.isObject(a[0]))
                            ...
                            m[t] = p.slice(0), o || (g = g.concat(p), o = !0);
                    else
                        m[t] = [];
            ...
            buildTicks: function() {
                ...
                for (u = "data" === c || "auto" === c && "series" === f ? u.data : "labels" === c ? u.labels : function(t, e, n, i) {
                    var a,
                        ...
                        h = e,
                        c = [];
                    if (d && (h = +r.startOf(h, "isoWeek", d)), h = +r.startOf(h, d ? "day" : l), r.diff(n, e, l) > 1e5 * u)
                ...
                return i.min = a, i.max = r, i._unit = l.unit || (s.autoSkip ? ui(l.minUnit, i.min, i.max, h) : function(t, e, n, i, a) {
                    ...
                    for (r = ni.length - 1; r >= ni.indexOf(n); r--)
                        if (o = ni[r], ei[o].common && t._adapter.diff(a, i, o) >= e - 1)
                            return o;
            ...
            getPixelForValue: function(t, e, n) {
                var i = null;
                if (void 0 !== e && void 0 !== n && (i = this._timestamps.datasets[n][e]), null === i && (i = li(this, t)), null !== i)
            ...
            e.exports = function() {
                ...
                function m(t) {
                    if (null == t._isValid) {
                        ...
                        if (t._strict && (a = a && 0 === e.charsLeftOver && 0 === e.unusedTokens.length && void 0 === e.bigHour), null != Object.isFrozen && Object.isFrozen(t))
                            return a;
                        t._isValid = a
                    }
                    return t._isValid
                ...
                function A(t, e) {
                    var n,
                        i = c({}, t);
                    for (n in e)
                        h(e, n) && (o(t[n]) && o(e[n]) ? (i[n] = {}, c(i[n], t[n]), c(i[n], e[n])) : null != e[n] ? i[n] = e[n] : delete i[n]);
                    for (n in t)
                ...
                function U(t, e) {
                    return t.isValid() ? (e = G(e, t.localeData()), H[e] = H[e] || function(t) {
                        ...
                        for (e = 0, n = a.length; e < n; e++)
                            B[a[e]] ? a[e] = B[a[e]] : a[e] = (i = a[e]).match(/\[[\s\S]/) ? i.replace(/^\[|\]$/g, "") : i.replace(/\\/g, "");
                        return function(e) {
                            var i,
                                r = "";
                            for (i = 0; i < n; i++)
                ...
                function me(t, e) {
                    if (null !== e) {
                        ...
                        if (e.abbr = t, null != de[t])
                            T("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), i = de[t]._config;
                        else if (null != e.parentLocale)
                            if (null != de[e.parentLocale])
                                i = de[e.parentLocale]._config;
                            else {
                                if (null == (n = fe(e.parentLocale)))
                                    return he[e.parentLocale] || (he[e.parentLocale] = []), he[e.parentLocale].push({
                                        name: t,
                                        config: e
                                    }), null;
                                i = n._config
                    ...
                    if (!t._d) {
                        for (i = function(t) {
                            ...
                            if (null != (e = t._w).GG || null != e.W || null != e.E)
                                r = 1, o = 4, n = be(e.GG, t._a[vt], qt(Le(), 1, 4).year), i = be(e.W, 1), ((a = be(e.E, 1)) < 1 || a > 7) && (l = !0);
                            else {
                        ...
                        }(t), null != t._dayOfYear && (o = be(t._a[vt], i[vt]), (t._dayOfYear > Dt(o) || 0 === t._dayOfYear) && (g(t)._overflowDayOfYear = !0), n = jt(o, 0, t._dayOfYear), t._a[bt] = n.getUTCMonth(), t._a[yt] = n.getUTCDate()), e = 0; e < 3 && null == t._a[e]; ++e)
                            t._a[e] = s[e] = i[e];
                        for (; e < 7; e++)
                    ...
                    if (t._f !== a.ISO_8601)
                        if (t._f !== a.RFC_2822) {
                            ...
                            for (i = G(t._f, t._locale).match(E) || [], e = 0; e < i.length; e++)
                                r = i[e], (n = (s.match(ht(r, t)) || [])[0]) && ((o = s.substr(0, s.indexOf(n))).length > 0 && g(t).unusedInput.push(o), s = s.slice(s.indexOf(n) + n.length), u += n.length), B[r] ? (n ? g(t).empty = !1 : g(t).unusedTokens.push(r), pt(r, n, t)) : t._strict && !n && g(t).unusedTokens.push(r);
                ...
                function Fe(t) {
                    ...
                    return t._locale = t._locale || pe(t._l), null === e || void 0 === n && "" === e ? p({
                        ...
                        for (a = 0; a < t._f.length; a++)
                            r = 0, e = b({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[a], Ae(e), m(e) && (r += g(e).charsLeftOver, r += 10 * g(e).unusedTokens.length, g(e).score = r, (null == i || r < i) && (i = r, n = e));
                        c(t, n || e)
                    }(t) : n ? Ae(t) : function(t) {
                        var e = t._i;
                ...
                })), L("millisecond", "ms"), Y("millisecond", 16), dt("S", et, q), dt("SS", et, Z), dt("SSS", et, $), xn = "SSSS"; xn.length <= 9; xn += "S")
                    dt(xn, at);
                function wn(t, e) {
                    e[kt] = k(1e3 * ("0." + t))
                }
                ...
                Mn.add = en, Mn.calendar = function(t, e) {
                    ...
                    if ("object" == typeof t)
                        for (var n = function(t) {
                            ...
                            }(t = N(t)), i = 0; i < n.length; i++)
                            this[n[i].unit](t[n[i].unit]);
                    else if (O(this[t = R(t)]))
                        return this[t](e);
                    return this
                ...
                return ri.isValid = function() {
                    ...
                    if (null != e) {
                        ...
                        null != de[t] && (null != de[t].parentLocale ? de[t] = de[t].parentLocale : null != de[t] && delete de[t]);
                    return de[t]
                }, a.locales = function() {
                    return C(de)
    ...
    rn._date.override("function" == typeof gi ? {
        _id: "moment",
        formats: function() {
            return mi
        },
        parse: function(t, e) {
            return "string" == typeof t && "string" == typeof e ? t = gi(t, e) : t instanceof gi || (t = gi(t)), t.isValid() ? t.valueOf() : null
        },
        format: function(t, e) {
        ...
        startOf: function(t, e, n) {
            return t = gi(t), "isoWeek" === e ? t.isoWeekday(n).valueOf() : t.startOf(e).valueOf()
        },
        endOf: function(t, e) {
    ...
    function wi(t, e, n, i, a) {
        ...
        if (i && a) {
            ...
            if (void 0 === n[0].angle)
                ...
                for (o = n[0].cx, s = n[0].cy, l = Math.sqrt(Math.pow(n[0].x - o, 2) + Math.pow(n[0].y - s, 2)), r = a - 1; r > 0; --r)
    ...
    function ki(t, e, n, i, a, r) {
        ...
        for (t.beginPath(), o = 0, s = g; o < s; ++o)
            d = n(u = e[l = o % g]._view, l, i), h = _i(u), c = _i(d), r && void 0 === f && h && (s = g + (f = o + 1)), h && c ? (b = p.push(u), y = v.push(d)) : b && y && (m ? (h && p.push(u), c && v.push(d)) : (wi(t, p, v, b, y), b = y = 0, p = [], v = []));
    ...
    var Mi = {
            ...
            afterDatasetsUpdate: function(t, e) {
                var n,
                    ...
                    l = [];
                for (i = 0; i < o; ++i)
                    r = null, (a = (n = t.getDatasetMeta(i)).dataset) && a._model && a instanceof wt.Line && (r = {
                ...
                for (i = 0; i < o; ++i)
                    (r = l[i]) && (r.fill = yi(l, i, s), r.boundary = bi(r), r.mapper = xi(r))
            },
            beforeDatasetsDraw: function(t) {
                ...
                for (n = l.length - 1; n >= 0; --n)
                    (e = l[n].$filler) && e.visible && (a = (i = e.el)._view, r = i._children || [], o = e.mapper, s = a.backgroundColor || W.global.defaultColor, o && s && r.length && (H.canvas.clipArea(u, t.chartArea), ki(u, r, o, a, s, i._loop), H.canvas.unclipArea(u)))
            }
        },
                    ...
                    !function(t, e, i) {
                        if (!(isNaN(p) || p <= 0)) {
                            ...
                            if (c.fillStyle = Ci(i.fillStyle, a), c.lineCap = Ci(i.lineCap, r.borderCapStyle), c.lineDashOffset = Ci(i.lineDashOffset, r.borderDashOffset), c.lineJoin = Ci(i.lineJoin, r.borderJoinStyle), c.lineWidth = o, c.strokeStyle = Ci(i.strokeStyle, a), c.setLineDash && c.setLineDash(Ci(i.lineDash, r.borderDash)), n && n.usePointStyle) {
                                ...
                                c.fillRect(h.leftForLtr(t, p), e, p, m), 0 !== o && c.strokeRect(h.leftForLtr(t, p), e, p, m);
                            c.restore()
                        }
    ...
    for (var zi in Ri.filler = Ni, Ri.legend = Wi, Ri.title = Yi, en.helpers = H, function() {
        function t(t, e, n) {
            var i;
        ...
        }, H.color = k ? function(t) {
            return t instanceof CanvasGradient && (t = W.global.defaultColor), k(t)
        } : function(t) {
    ...
    }(), en._adapters = rn, en.Animation = K, en.animationService = J, en.controllers = Jt, en.DatasetController = it, en.defaults = W, en.Element = $, en.elements = wt, en.Interaction = re, en.layouts = me, en.platform = Ie, en.plugins = Le, en.Scale = xn, en.scaleService = Re, en.Ticks = on, en.Tooltip = Ge, en.helpers.each(fi, (function(t, e) {
        en.scaleService.registerScaleType(e, t, t._defaults)
    })), Ri)
        Ri.hasOwnProperty(zi) && en.plugins.register(Ri[zi]);
    en.platform.initialize();
    var Ei = en;
    return "undefined" != typeof window && (window.Chart = en), en.Chart = en, en.Legend = Ri.legend._element, en.Title = Ri.title._element, en.pluginService = en.plugins, en.PluginBase = en.Element.extend({}), en.canvasHelpers = en.helpers.canvas, en.layoutService = en.layouts, en.LinearScaleBase = Dn, en.helpers.each(["Bar", "Bubble", "Doughnut", "Line", "PolarArea", "Radar", "Scatter"], (function(t) {
        en[t] = function(e, n) {
